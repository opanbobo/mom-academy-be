...
{    
    ...
    public function index(HomeModel $model)
    {
        ...
        // $data_course = Api::course_with_limit([
        //     'limit' => 3,
        ...
        // $data['course'] = $data_course->data;
        // $data['event'] = $data_event->data;
        ...
        // dd($this->currentTime);
        $course = $model->db_course_lists($param);
        $module = $model->db_module_lists($param);
